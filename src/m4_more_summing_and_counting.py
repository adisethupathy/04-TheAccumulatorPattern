...
def run_test_factorial():
    ...
    print('Test 3 expected:', answer_from_oracle)
    print('actual:', answer_from_my_code)

    # Test 4:
    answer_from_oracle = math.factorial(25)
    answer_from_my_code = factorial(25)
    print('Test 4 expected:', answer_from_oracle)
    print('actual:', answer_from_my_code)

    # Test 5
    answer = 6
    actual = factorial(3)
    print('Test 5 expected:', answer)
    print('actual:', actual)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(1, 7, 0.2)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 4
    answer = count_cosines_from(0, 8, 0.42)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(9, 14, 0.15)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 34
    answer = count_cosines_from(1, 100, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(2, 9, 0.44)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.845
    answer = sum_unit_fractions_from(5, 10)
    print("Test 3 expected:", expected)
    print('actual:', answer)
