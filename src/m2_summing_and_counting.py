...
def run_test_count_sines_from():
    ...
    # Test 5:
    expected = 52
    answer = count_sines_from(1, 80)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 10
    answer = count_sines_from(0, 15)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 4:
    expected = 39
    answer = count_sines_vs_cosines(39)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 45
    answer = count_sines_vs_cosines(45)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 81
    answer = count_sines_vs_cosines(79)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)
